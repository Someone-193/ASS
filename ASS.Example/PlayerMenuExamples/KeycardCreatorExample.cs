        ...
        private static ASSGroup Generator(Player owner)
        {
            ...
            List<ASSBase> settings = 
                [
                    ...
                    new ASSTextInput(107, "Keycard Color (Hex)", string.Empty, "#00FFFF", 7),
                    new ASSTextInput(108, "Keycard Permissions Color (Hex)", string.Empty, "#FF0000", 7),
                ];
            ...
            switch (index)
            {
                case 0:
                    settings.AddRange([
                        new ASSTextInput(109, "Holder Name", string.Empty, "A very cool person", ushort.MaxValue),
                        new ASSTextInput(113, "Serial Label", string.Empty, "69420", ushort.MaxValue),
                ...
                case 1:
                    settings.AddRange([
                        new ASSTextInput(109, "Holder Name", string.Empty, "A very cool person", ushort.MaxValue),
                        new ASSTextInput(110, "Keycard Label", string.Empty, "Meth Card", ushort.MaxValue),
                        new ASSTextInput(111, "Label Color (Hex)", string.Empty, "#00FFFF", 7),
